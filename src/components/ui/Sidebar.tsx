          ...
          return (
            <Link
              ...
              className={`
                ...
                ${isActive 
                  ? 'bg-[#2D2D2D] text-white border-l-4 border-green-500' 
      ...
      <div className="p-6 border-t border-gray-800">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-white">Lucas Fontoura</p>
            <p className="text-xs text-gray-400">devlucasfontoura@gmail.com</p>
          </div>
        </div>
      </div>
    </div>
