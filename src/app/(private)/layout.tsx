    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <main className="flex-1">
        <PageContainer>
            ...
            <div className="max-w-7xl mx-auto px-6 py-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-6">
                  <Link href="/dashboard" className="text-gray-600 hover:text-primary dark:text-gray-300">
                    Dashboard
                  </Link>
                  <Link href="/nova-transacao" className="btn-primary">
                    Nova Transação
                  </Link>
                  <button 
          ...
          <main className="min-h-screen bg-gradient-to-br from-background via-background to-gray-100">
            {children}
          </main>
        </PageContainer>
      </main>
